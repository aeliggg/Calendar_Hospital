...
class Instance
{
    ...
    /* LES Getters */
        ...
        int get_Shift_Duree(int i_Id_Shift) ;
        vector<int> get_vector_Shift_Suc_Interdit(int i_Id_Shift) ;
        int get_Personne_Duree_total_Max(int i_Id_Personne) ;
        int get_Personne_Duree_total_Min(int i_Id_Personne) ;
        int get_Personne_Nbre_Shift_Consecutif_Max(int i_Id_Personne) ;
        int get_Personne_Nbre_Shift_Consecutif_Min(int i_Id_Personne) ;
        int get_Personne_Jour_OFF_Consecutif_Min(int i_Id_Personne) ;
        int get_Personne_Nbre_WE_Max(int i_Id_Personne) ;
        int get_Personne_Shift_Nbre_Max(int i_Id_Personne, int i_Id_Shift) ;
        vector<int> get_vector_Personne_Id_Jour_Conges(int i_Id_Personne) ;
        int get_Poids_Affectation_Pers_Jour_Shift(int i_Id_Personne, int i_Id_Jour, int i_Id_Shift) ;
        int get_Poids_Refus_Pers_Jour_Shift(int i_Id_Personne, int i_Id_Jour, int i_Id_Shift) ;
