...
vector<int> Instance::get_vector_Shift_Suc_Interdit(int i_Id_Shift) 
{
    if(v_Shift.size()==0)
        return vector<int> ();
    if((i_Id_Shift>=0)&&(i_Id_Shift<i_Nombre_Shift))
...
int Instance::get_Personne_Duree_total_Max(int i_Id_Personne) 
{
...
int Instance::get_Personne_Duree_total_Min(int i_Id_Personne) 
{
    if(v_Personne.size()==0)
        return 0;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
int Instance::get_Personne_Nbre_Shift_Consecutif_Max(int i_Id_Personne) 
{
    if(v_Personne.size()==0)
        return 0;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
int Instance::get_Personne_Nbre_Shift_Consecutif_Min(int i_Id_Personne) 
{
    if(v_Personne.size()==0)
        return 0;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
int Instance::get_Personne_Jour_OFF_Consecutif_Min(int i_Id_Personne) 
{
    if(v_Personne.size()==0)
        return 0;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
int Instance::get_Personne_Nbre_WE_Max(int i_Id_Personne) 
{
    if(v_Personne.size()==0)
        return 0;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
int Instance::get_Personne_Shift_Nbre_Max(int i_Id_Personne, int i_Id_Shift) 
{
    if(v_Personne.size()==0)
        return 0;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
vector<int> Instance::get_vector_Personne_Id_Jour_Conges(int i_Id_Personne) 
{
    if(v_Personne.size()==0)
        return vector<int> ();
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
...
int Instance::get_Poids_Affectation_Pers_Jour_Shift(int i_Id_Personne, int i_Id_Jour, int i_Id_Shift) 
{
...
int Instance::get_Poids_Refus_Pers_Jour_Shift(int i_Id_Personne, int i_Id_Jour, int i_Id_Shift) 
{
...
int Instance::get_Nbre_Personne_Requis_Jour_Shift(int i_Id_Jour, int i_Id_Shift) 
{
...
int Instance::get_Poids_Personne_En_Plus_Jour_Shift(int i_Id_Jour, int i_Id_Shift) 
{
...
int Instance::get_Poids_Personne_En_Moins_Jour_Shift(int i_Id_Jour, int i_Id_Shift) 
{
...
bool Instance::is_possible_Shift_Succede(int i_Id_Shift, int i_Id_Shift_Successeur) 
{
    if(v_Shift.size()==0)
        return false;
    if((i_Id_Shift>=0)&&(i_Id_Shift<i_Nombre_Shift))
...
bool Instance::is_Available_Personne_Jour(int i_Id_Personne, int i_Id_Jour) 
{
    if(v_Shift.size()==0)
        return false;
    if((i_Id_Personne>=0)&&(i_Id_Personne<i_Nombre_Personne))
